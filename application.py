...
CLIENT_ID = json.loads(
    open('/var/www/MovieCatalog/MovieCatalog/client_secrets.json', 'r').read())['web']['client_id']
        ...
        if form.validate_on_submit():
            ...
            if request.method == 'POST':
                ...
                if category and title is None and cover is None:
                    ...
                    flash('The category does not exist !', 'warning')
        return render_template('addNewMovie.html', form=form)
    else:
        return redirect(url_for('home'))
...
def deleteMovie(movie_name):
    ...
    if 'username' in login_session:
        ...
        if movie.user_id == user.id:
            flash('The movie has been removed !', 'success')
...
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets('/var/www/MovieCatalog/MovieCatalog/client_secrets.json', scope='')
