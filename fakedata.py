...
cat1 = Categories(name='Action')
session.add(cat1)
session.commit()

cat2 = Categories(name='Comedy')
session.add(cat2)
session.commit()

cat3 = Categories(name='Fantasy')
session.add(cat3)
session.commit()

cat4 = Categories(name='Horror')
session.add(cat4)
session.commit()

cat5 = Categories(name='Science-fiction')
session.add(cat5)
session.commit()

cat6 = Categories(name='Thriller')
session.add(cat6)
session.commit()

cat7 = Categories(name='Western')
session.add(cat7)
session.commit()

cat8 = Categories(name='Animation')
session.add(cat8)
session.commit()
